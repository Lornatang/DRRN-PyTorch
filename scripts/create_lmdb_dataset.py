...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", type=str, default="TB291/DRRN/train/target", help="Path to image directory. (Default: ``TB291/DRRN/train/target``)")
    parser.add_argument("--lmdb_path", type=str, default="train_lmdb/DRRN/TB291_HR_lmdb", help="Path to lmdb database. (Default: ``train_lmdb/DRRN/TB291_HR_lmdb``)")
